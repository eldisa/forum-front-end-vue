  ...
  methods: {
    fetchUser() {
      ...
      this.user = {
        ...
        name: user.name,
        email: user.email,
        followingsLength: user.Followings.length,
        followersLength: user.Followers.length,
        commentsLength: user.Comments.length,
        favoritedRestaurantsLength: user.FavoritedRestaurants.length
      },
          this.isFollowed = dummyData.isFollowed
      this.followings = user.Followings
      this.followers = user.Followers
      this.comments = user.Comments
      this.favoritedRestaurants = user.FavoritedRestaurants
    },
    addFollowing(user){
      this.followers.push(user)
      this.followers = this.followers.filter( (follower, index)=>
          this.followers.indexOf(follower) === index
      )
      this.user = {
        ...this.user,
